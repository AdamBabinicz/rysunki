...
export const InfoDataTwo = {
  heading: "Edukacja u najlepszych",
  paragraphOne:
...
export const InfoDataSeven = {
  heading: "Jak nie zostałem Janem Matejką",
  paragraphOne:
    "Do ogniska na ul. Sienkiewicza 12 chodziłem pieszo (ok. 2,5 km w jedną stronę) dwa razy w tygodniu (we wtorek i piątek). Aby urozmaicić sobie czas w pokonywaniu tej odległości, wymyślałem dzieje różnych fikcyjnych władców do 11 pokolenia (oczywiście pamiętałem imiona wszystkich).",
  paragraphTwo:
